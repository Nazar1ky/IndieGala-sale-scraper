...
def get_data():
    ...
    for i in range(1, total_pages + 1):
        ...
        response = requests.get(f"https://www.indiegala.com/store_games_rss?page={i}&sale=true")
        soup = BeautifulSoup(response.content, "xml")
        ...
        for product in products:
            ...
            data.append({
                ...
                "product_discount_end": datetime.datetime.fromisoformat(product_discount_end).strftime("%d/%m/Y"),
